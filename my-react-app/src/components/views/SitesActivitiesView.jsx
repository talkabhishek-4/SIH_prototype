  ...
  return (
    <div className="p-6 space-y-5 bg-[#f3f6f9] min-h-screen text-[#1c2a38]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
        ...
        <div className="lg:col-span-8 bg-[#031c19] border border-[#0d3b36] rounded-xl overflow-hidden shadow-md flex flex-col h-[600px] relative">
          {/* Map Top Header */}
          ...
          <div className="relative flex-1 bg-[#021816] bg-[radial-gradient(#083832_1px,transparent_1px)] [background-size:24px_24px] overflow-hidden">
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none stroke-amber-500/40" strokeDasharray="6,6" strokeWidth="2">
              <line x1="60%" y1="22%" x2="79%" y2="38%" />
              <line x1="79%" y1="38%" x2="69%" y2="72%" />
            </svg>

            {/* Zone Map Labels & Interactive Nodes */}
            {/* 1. Compressor Area */}
            <div
              className={`absolute top-[15%] left-[53%] -translate-x-1/2 p-3 rounded-xl border border-[#0f544c] bg-[#002e29]/80 backdrop-blur-xs flex items-center gap-3 cursor-pointer transition hover:scale-105 ${
            ...
            {/* 2. Wellhead */}
            <div
              className={`absolute top-[32%] left-[73%] -translate-x-1/2 p-3 rounded-xl border border-[#0f544c] bg-[#002e29]/80 backdrop-blur-xs flex items-center gap-3 cursor-pointer transition hover:scale-105 ${
            ...
            {/* 3. Processing Unit */}
            <div
              className={`absolute top-[67%] left-[63%] -translate-x-1/2 p-3.5 rounded-xl border border-[#0f544c] bg-[#002e29]/80 backdrop-blur-xs flex items-center gap-3 cursor-pointer transition hover:scale-105 ${
            ...
            {/* 4. Workshop */}
            <div
              className={`absolute top-[67%] left-[48%] -translate-x-1/2 p-3.5 rounded-xl border border-[#0f544c] bg-[#002e29]/80 backdrop-blur-xs flex items-center gap-3 cursor-pointer transition hover:scale-105 ${
            ...
            {/* 5. Storage Area */}
            <div
              className={`absolute top-[76%] left-[78%] -translate-x-1/2 p-3.5 rounded-xl border border-[#0f544c] bg-[#002e29]/80 backdrop-blur-xs flex items-center gap-3 cursor-pointer transition hover:scale-105 ${
